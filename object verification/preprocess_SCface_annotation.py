...
# types_name = os.listdir("../datasets/SCface/")
# types_name = sorted(types_name)
# for fi in types_name:
#     fi_dir = fi.split("_", 1)
#     path = os.path.join("../datasets/SCface/" + str(fi_dir[0]) + "/")
#     if not os.path.isdir(path):
#         os.makedirs(path)
#
#     f_src = os.path.join("../datasets/SCface/" + str(fi_dir[0]) + "_" + str(fi_dir[1]))
...
# dir_names = os.listdir("../datasets/SCface/")
# dir_names.sort()
# dir_names.sort(key=lambda x: int(x.split('_')[0][:6]))
# lable = 0
# for fi in dir_names:
#     src = "../datasets/SCface/" + fi
#     dst = "../datasets/SCface/" + str(lable)
#     os.rename(src, dst)
#     lable = lable + 1
...
# pairs_path = "../datasets/SCface_test_pair.txt"
# f = open(pairs_path, 'a')
# dir_names = os.listdir("../datasets/SCface/")
# for fi in dir_names:
#     file_dirs = "../datasets/SCface/" + fi + "/"
...
#     file_dirs = os.listdir(file_dirs)
#     for file_name0 in file_dirs:
#         dir_indexes = np.random.choice(range(0, 130), 25)
#         while str(fi) in dir_indexes.astype(str):
#             dir_indexes = np.random.choice(range(0, 130), 25)
#         for dir_indexe in dir_indexes:
#             dir_name1 = "../datasets/SCface/" + str(dir_indexe) + "/"
...
datafile = h5py.File("../datasets/SCface_test_data.h5", 'w')
...
SCface112 = h5py.File("../datasets/SCface_test_data.h5", 'r')
